        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _AgreementHeader(l10n: l10n, theme: theme, extendedColors: extendedColors),
              const SizedBox(height: 24),
              _AgreementContent(l10n: l10n, theme: theme, extendedColors: extendedColors),
              const SizedBox(height: 24),
...
class _AgreementHeader extends StatelessWidget {
  ...
  const _AgreementHeader({required this.l10n, required this.theme, required this.extendedColors});
...
class _AgreementContent extends StatelessWidget {
  ...
  const _AgreementContent({required this.l10n, required this.theme, required this.extendedColors});
