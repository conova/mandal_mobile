...
class BondSellSuccessScreen extends StatefulWidget {
  const BondSellSuccessScreen({super.key});

  @override
  State<BondSellSuccessScreen> createState() => _BondSellSuccessScreenState();
}

class _BondSellSuccessScreenState extends State<BondSellSuccessScreen>
