...
class OrderDetailItem {
  ...
  const OrderDetailItem(this.label, this.value);
}

/// Захиалгын дэлгэцүүдийн ДУНДЫН component — "дээш сөхөж баталгаажуулах"
/// бүх урсгалд (бонд авах/зарах, барьцаалах г.м.) ашиглана:
///
///   • Цагаан хэсэгт: нэр, дэд нэр, задаргааны мөрүүд + нийт дүн
///   • Доод teal хэсгийг дээш чирж баталгаажуулна
///   • Амжилтын дэлгэц: ✓ animation, гарчиг, тайлбар, товч
///   • PopScope — баталгаажиж эхэлсний дараа буцахыг хориглоно
///     (давхар илгээхээс сэргийлнэ)
class SwipeOrderConfirmation extends StatefulWidget {
  final String title;
  final String subtitle;

  /// Задаргааны мөрүүд (Төрөл, Ширхэг, Нэгж үнэ, ...)
  final List<OrderDetailItem> details;

  /// Тасархай зураасны доорх нийт дүнгийн мөр
  ...
  /// Амжилтын товч дарахад / амжилтын дараа system back дарахад.
  ...
  @override
  State<SwipeOrderConfirmation> createState() => _SwipeOrderConfirmationState();
}

class _SwipeOrderConfirmationState extends State<SwipeOrderConfirmation>
      ...
      child: Scaffold(
        ...
        body: AnimatedBuilder(
          ...
          builder: (context, child) {
            ...
            return Stack(
              children: [
                // Цагаан баталгаажуулалтын контент
                Positioned.fill(
                  bottom: bottomSheetHeight,
                  // Баталгаажуулж эхэлсний дараа бүдгэрсэн контент (back
                  // товч орно) дарагдахгүй байх ёстой
                  child: IgnorePointer(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: _buildDetails(theme, extendedColors),
                                ),
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: _showSuccess
                          ? _buildSuccessContent(theme, extendedColors)
                          : Opacity(
                              opacity: _contentFadeAnimation.value,
                              child: Column(
  ...
  /// Задаргааны мөрүүд + тасархай зураас + нийт дүн
  Widget _buildDetails(ThemeData theme, ExtendedColors extendedColors) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
            ...
            return Row(
              ...
              children: List.generate(dashCount, (_) {
                return SizedBox(
                  ...
                  child: DecoratedBox(
                    decoration:
                        BoxDecoration(color: extendedColors.neutral400),
                  ),
                );
              }),
            );
  ...
  Widget _buildSuccessContent(ThemeData theme, ExtendedColors extendedColors) {
    return SafeArea(
      child: Padding(
