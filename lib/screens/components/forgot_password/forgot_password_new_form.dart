...
class ForgotPasswordNewForm extends StatefulWidget {
  ...
  @override
  State<ForgotPasswordNewForm> createState() => _ForgotPasswordNewFormState();
}

class _ForgotPasswordNewFormState extends State<ForgotPasswordNewForm> {
