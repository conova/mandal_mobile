  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isHeader ? colorScheme.surfaceVariant.withOpacity(0.3) : Colors.transparent,
          ...
          Expanded(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                fontSize: 13,
                color: isHeader ? colorScheme.onSurface : colorScheme.onSurface.withOpacity(0.8),
              )
            )
          ),
          Expanded(
